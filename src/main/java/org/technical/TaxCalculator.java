...
public class TaxCalculator {
    public static double calculateTax(double income) {
        ...
        double rate;
        if (income <= 5) rate = 0.05;
        else if (income <= 10) rate = 0.10;
        else if (income <= 18) rate = 0.15;
        else if (income <= 32) rate = 0.20;
        else if (income <= 52) rate = 0.25;
        else if (income <= 80) rate = 0.30;
        else rate = 0.35;
